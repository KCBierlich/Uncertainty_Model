flatten_data = function(images, pixels, train_objs, priors_altitude,
  ...
  # (optional) empirical lengths, for additional validation
  nim_pkg$consts$empirical_lengths = cbind(
    Empirical = pixels$EmpiricalLength,
    Barometer = pixels$EmpiricalBarometerLength,
    Laser = pixels$EmpiricalLaserLength
  )
